...
lib.xdp_log_hexdump.argtypes = [c_char_p, c_int, c_int, c_char_p, c_void_p, c_size_t]
lib.xdp_log_test.restype = None
lib.xdp_log_test.argtypes = [c_bool]
...
class XdpLog(object):
    ...
    def msg(module, line, level, format, *args):
        ...
        Log message
        """
        return lib.xdp_log_msg(module, line, level, format, *args)

    @staticmethod
    def hexdump(module, line, level, description, buffer, buffer_len):
        """
        Hexdump
        """
        return lib.xdp_log_hexdump(module, line, level, description, buffer, buffer_len)
    ...
    def test(verbose):
        ...
        Self test of this class.
        """
        return lib.xdp_log_test(verbose)
